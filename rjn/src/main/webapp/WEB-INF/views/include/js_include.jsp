...
<script src="${rc.getContextPath()}/resources/js/core/jquery.min.js"></script> 
<script src="${rc.getContextPath()}/resources/js/core/script.js"></script>
...
<script src="${rc.getContextPath()}/resources/js/core/angular-main.js"></script>
