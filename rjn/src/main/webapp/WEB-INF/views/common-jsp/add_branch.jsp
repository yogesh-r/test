										...
										<div class="row">
											...
											<div class="col-md-6">
												<span>Branch Name* </span> <input type="text"
													...
													name="branchName" ng-model="event_name"
													class="form-control" onblur="notnull();" required /> <span
													id="isE"></span>
											</div>
										</div>
										<div class="row">
							...
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-sm-3">
										...
										</span> <input class="field form-control" id="street_number"
											name="addr" placeholder="Enter Your Door No." required></input>
									</div>
									<div class="col-sm-3">
								...
								<div class="row">
									...
									<div class="col-sm-3">
										...
										</span> <input value="${thisBranch.country}"
											class="field form-control" name="country" id="country"
											readOnly></input>
									</div>
									<div class="col-sm-3">
										<span>ZipCode* <label></label>
										</span> <input value="${thisBranch.zipcode}" type="text"
								...
								<div class="row">
									...
									<div class="col-sm-3">
										<span>Email-ID* <label></label>
											...
											name="managerEmail" ng-model="event_name"
											class="form-control" required>
									</div>
									<div class="col-sm-3">
										<span>Contact No* <label></label>
										</span> <input value="${thisBranch.managerMobile}" type="text"
											name="managerMobile" ng-model="event_name"
											class="form-control" required pattern=[7-9][0-9]{9}
											maxlength="10"
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-3">
										...
										</span> <select class="form-control" name="license_name"
											id="license_name">
									...
									<div class="col-sm-3">
										...
										</span> <select name="license_key" id="license_key"
											class="form-control" onblur="check();">
								...
								<div class="row">
									...
									<div class="col-sm-3">
										...
										</span> <input type="text" name="billing_frequency"
											id="billing_frequency" class="form-control">
									</div>
									<div class="col-sm-3">
